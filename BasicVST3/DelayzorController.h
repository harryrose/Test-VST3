#ifndef _Delayzor_CONTROLLER_H_
#define _Delayzor_CONTROLLER_H_
...
class DelayzorController : public EditController //also extend other things such as IMidiMapping to get extra functionality
{
public:
	DelayzorController(void);
	
	static FUnknown * createInstance (void * context)
	{
		return (IEditController *) new DelayzorController;
	}
...
#endif //#ifndef _Delayzor_CONTROLLER_H_